...
static int config_props(AVFilterLink *outlink) {
    ...
    if(ff_tvai_verifyAndSetInfo(&info, inlink, outlink, tvai->model, tvai->estimateFrameCount > 0, tvai->model, ModelTypeUpscaling, tvai->device, tvai->extraThreads, tvai->vram,
